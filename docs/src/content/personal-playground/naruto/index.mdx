...
description: '"Itami o kanjiro. Itami o kangaero. Itami o uketore. Itami o shire. Itami o shiranu mono ni, hontō no heiwa wa wakaran..."'
ogImageSrc: /og-images/example-naruto.jpg
---
...
<ExampleTabs>
  <Naruto client:visible slot="scene" />
  <Fragment slot="code">
    ```typescript
