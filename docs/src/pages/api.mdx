...
| -------------- | ---------------------------- | ------- | -------------------------------------------------------------------------- |
| `enableFilter` | `(enabled: boolean) => void` | `false` | Pencil-style SVG filter. Can be slow on Safari with many paths during zoom |
...
| Method               | Signature                     | Default | Description                                         |
| -------------------- | ----------------------------- | ------- | --------------------------------------------------- |
| `setFilterIntensity` | `(intensity: number) => void` | `1.25`  | Pencil displacement intensity. Higher = more wobble |
